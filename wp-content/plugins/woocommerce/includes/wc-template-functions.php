...
if (!function_exists('woocommerce_breadcrumb')) {
    ...
    function woocommerce_breadcrumb($args = array())
    {
        ...
        $args = wp_parse_args(
            ...
            apply_filters(
                ...
                array(
                    ...
                    'before' => '',
                    'after' => '',
                    'home' => _x('בית', 'breadcrumb', 'woocommerce'),
                )
            )
        );
        ...
        if (strpos(home_url($wp->request), 'product-category') !== false) {
            $breadcrumbs = new WC_Breadcrumb();
            $args['breadcrumb'] = null;

            if (!empty($args['home'])) {
                $breadcrumbs->add_crumb($args['home'], apply_filters('woocommerce_breadcrumb_home_url', home_url()));
            }

            $breadcrumbs->add_crumb('המוצרים', get_site_url() . '/products');
            $args['breadcrumb'] = $breadcrumbs->generate();
        }
    ...
    function wc_dropdown_variation_attribute_options($args = array())
    {
        $args = wp_parse_args(
            ...
            array(
                ...
                'name' => '',
                'id' => '',
                'class' => 'form-control order-0 mr-4 woocommerce_dropdown_variation',
