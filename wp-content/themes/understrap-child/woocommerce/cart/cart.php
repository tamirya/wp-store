...
do_action('woocommerce_before_cart'); ?>
    ...
    <form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
        ...
        <table dir="rtl" class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
            <thead>
            <tr>
                <th class="product-remove">&nbsp;</th>
                <th class="product-thumbnail">&nbsp;</th>
                <th class="product-name"><?php esc_html_e('מוצר', 'understrap'); ?></th>
                <th class="product-price"><?php esc_html_e('מחיר', 'understrap'); ?></th>
                <th class="product-quantity"><?php esc_html_e('כמות', 'understrap'); ?></th>
                <th class="product-subtotal"><?php esc_html_e('סה"כ', 'understrap'); ?></th>
            </tr>
            </thead>
            <tbody>
                    ...
                    <?php if (wc_coupons_enabled()) { ?>
                        <div class="coupon">
                            <label for="coupon_code"><?php esc_html_e('Coupon:', 'understrap'); ?></label> <input
                                    ...
                                    value="" placeholder="<?php esc_attr_e('קוד קופון', 'understrap'); ?>"/>
                            <button type="submit" class="btn btn-outline-primary" name="apply_coupon"
                                    value="<?php esc_attr_e('הזן קופון', 'understrap'); ?>"><?php esc_attr_e('הזן קופון', 'understrap'); ?></button>
                            <?php do_action('woocommerce_cart_coupon'); ?>
                        </div>
                    <?php } ?>

                    <button type="submit" class="btn btn-outline-primary" name="update_cart"
                            value="<?php esc_attr_e('עדכן עגלה', 'understrap'); ?>"><?php esc_html_e('עדכן עגלה', 'understrap'); ?></button>
